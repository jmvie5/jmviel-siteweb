        ...
        <div className="bg-[url(../images/coding.webp)] bg-cover h-96">
            <div className="grid grid-rows-3 justify-between text-jmv_white h-96 w-[61%] xs:w-[50%] ">
                ...
                <div className="ml-4 row-span-2">
                    ...
                    <p className='my-4'>Spécialisé en développement web, j'aime aussi le développement de jeux vidéos et de programmes utilitaires.</p>
                </div>
            </div>
        </div>
        ...
        <div className='grid grid-cols-1 max-w-7xl self-center'>
            ...
            <div className='my-4 mx-2 sm:mx-4'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 m-4 gap-4 place-items-center'>
                    <a title="React" href="https://react.dev/"><StaticImage className="w-24 transition duration-300 ease-in hover:scale-110 " alt="React-icon" src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/512px-React-icon.svg.png"/></a>
                    ...
                    <a title="GatsbyJS" href="https://gastbyjs.com"><StaticImage className="w-24 transition duration-300 ease-in hover:scale-110" alt="GatsbyJS logo" src="../images/informatique/gatsbyjs.webp" /></a>
                    ...
                    <a title="Tailwind CSS" href="https://tailwindcss.com"><StaticImage className="w-24 transition duration-300 ease-in hover:scale-110" alt="Tailwind CSS Logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/Tailwind_CSS_Logo.svg/512px-Tailwind_CSS_Logo.svg.png"/></a>
                    ...
                    <a title="HTML5" href="https://html.spec.whatwg.org/multipage/"><StaticImage className="w-24 transition duration-300 ease-in hover:scale-110" alt="HTML5 logo" src="../images/informatique/html5.webp"/></a>
                    ...
                    <a title="Python" href="https://www.python.org/"><StaticImage className="w-24 transition duration-300 ease-in hover:scale-110" alt="Python logo" src="../images/informatique/python.webp"/></a>
